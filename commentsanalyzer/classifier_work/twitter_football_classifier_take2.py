...
def main():
    df = pd.read_csv("F://Twitter Data//twitter_football_dataframe_classifier_labelled.csv")
    print("CSV loaded")
    print(df.shape)
    ...
    print(report_final)
    dump(classifier_linear, '../twitter_classifier_football_v1.joblib')
    dump(vectorizer, '../twitter_vectorizer_football_v1.joblib')
